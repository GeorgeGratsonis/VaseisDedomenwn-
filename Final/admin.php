...
<body>
        ...
        <div id="navbar-div" class="container-fluid">
            ...
            <div id="navbar-items">
                <form action="backup.php" method="post">
                    <button type="submit" class="button" name="submit">Backup</button>
                </form>
                &nbsp;
                &nbsp;
                <form action="restore.php" method="post">
                    <button type="submit" class="button" name="submit">Restore</button>
                </form>
                &nbsp;
                &nbsp;
    ...
    <?php
        if (isset($_GET["error"])) {
            ...
            } else if ($_GET["error"] == "failedbackup") {
                echo "<p class='error-message text-center'>Backup failed!</p>";
            ...
            <div class="col-md-4">
                <div class="card" id="card-container-layout">
                    <div class="card-body" id="card">
                        ...
                        <p class="card-text" id="paragraph">View operators who have loaned the same amount of books (over 20) in a year</p>
            ...
            <div class="col-md-4 box1">
                <div class="card" id="card-container-layout">
                    <div class="card-body" id="card">
                        ...
                        <a class="btn btn-primary" id="show-btn" href="operatorslist.php">Show</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
