...
<body>
    ...
    <?php
        if (isset($_GET["error"])) {
            if ($_GET["error"] == "successreview") {
                echo "<p class='noerror-message text-center'>Review submitted!</p>";
            }
        }
    ?>
            ...
            <div class="col-md-12 box">
                <div class="card" id="card-container">
                    <div class="card-body" id="card">
                        ...
                        $query = "SELECT Book.Title, Book.Publisher, Book.ISBN, Book.Number_of_pages, Book.Summary, Book.Image, Book.Language, Book.Keywords, Borrowing.Borrowing_Date, Borrowing.Returned, Book.Book_ID
                        FROM Borrowing
                                ...
                                echo '<table class="table">';
                                    ...
                                    while($row = mysqli_fetch_row($result)){
                                        echo '<tr>';
                                            ...
                                            echo '<td>';
                                                echo '<a type="button" href="./review.php?id=' . $row[10]. '">';
